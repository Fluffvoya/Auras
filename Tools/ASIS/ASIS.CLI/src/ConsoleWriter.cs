...
static class ConsoleWriter
{
    ...
    public static void Info(string msg) => AnsiConsole.MarkupLine($"[orange3]{Escape(msg)}[/]");
    public static void Title(string msg) => AnsiConsole.MarkupLine($"[bold darkorange]{Escape(msg)}[/]");
  ...
  ╚═╝  ╚═╝ ╚══════╝ ╚═╝ ╚══════╝";
        ...
        AnsiConsole.MarkupLine($"[orange3]{Escape(asciiArt)}[/]");
